...
export function VersionHistory({ writingId, onRestoreVersion, onOpenChange }: VersionHistoryProps) {
      ...
      <DialogContent className="sm:max-w-[625px] max-h-[80vh] flex flex-col p-0">
        <DialogHeader className="px-6 pt-6">
          ...
          <DialogDescription className="text-sm text-muted-foreground">
            Access your recent document versions. Only the last 3 versions are preserved for quick restoration.
          </DialogDescription>
        </DialogHeader>
        <div className="flex-1 overflow-y-auto px-6 pb-6">
          <div className="space-y-4 mt-4">
            {isLoading ? (
              ...
              <div className="text-center text-muted-foreground py-4">No previous versions found</div>
            ) : (
              versions.map((version) => (
                ...
                >
                  ...
                  <div className="text-sm bg-muted p-3 rounded">
                    <p className="font-medium mb-2 break-words">{version.title}</p>
